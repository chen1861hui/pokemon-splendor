...
const trainerCards = [
  ...
  { id: "brock", pokedexId: 95, labelKey: "brockTrainer", image: trainerPixelSpriteUrl("brock-gen3"), fallbackImage: "/assets/trainers/brock-art.png" },
  { id: "misty", pokedexId: 54, labelKey: "mistyTrainer", image: trainerPixelSpriteUrl("misty-gen3"), fallbackImage: "/assets/trainers/misty-art.png" },
  { id: "rocket", styleId: "giovanni", pokedexId: 53, labelKey: "giovanniTrainer", image: trainerPixelSpriteUrl("giovanni-gen3"), fallbackImage: "/assets/trainers/team-rocket-art.png" }
];
...
elements.backgroundSelect.addEventListener("change", () => {
  selectedGameBackgroundId = gameBackgrounds.some(({ id }) => id === elements.backgroundSelect.value)
    ? elements.backgroundSelect.value
    : "current";
